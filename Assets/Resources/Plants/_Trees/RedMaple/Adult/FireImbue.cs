...
public class FireImbue : MonoBehaviour, IInteractable
{
    ...
    public void Interact()
    {
        ...
        bool equippedItemIsImbuable = imbuableItems.ItemIdIsFireImbuable(equippedItemId);

        if (equippedItemIsImbuable)
        {
            string imbuedId = imbuableItems.GetFireImbuedItemId(equippedItem.type.id);
            if (imbuedId != null)
            {
